...
|Week 3|Abstraction is All You Need: 함수(functions)의 선언(declare), 정의(define), 호출(call), 재귀함수(recursions), 고차함수(higher-order func)|[3-1](https://youtu.be/gY1-H-G7Ehs), [3-2](https://youtu.be/XFCY2rJa5Js)|[Assignment 2](https://classroom.github.com/a/G4GTBeZ6)|
